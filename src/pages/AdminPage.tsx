...
const AdminPage = () => {
  ...
  const handleImageUpload = (e, formType) => {
    ...
    if (file) {
      ...
      // For this demo, we'll just set a local URL
  ...
  const handleDeleteItem = (id, type) => {
    // In a real application, you'd delete the item from the database
    // For this demo, we'll just show a success toast
    toast({
      title: "Успешно удалено",
      description: `Элемент был успешно удален из базы данных.`,
      variant: "default",
    });
  };
  ...
  const handleDoctorSubmit = (e) => {
    ...
    if (!doctorForm.name || !doctorForm.specialization || !doctorForm.experience) {
      toast({
        title: "Ошибка",
    ...
    // In a real application, you'd save the data to a database
    // For this demo, we'll just show a success toast
    toast({
  ...
  const handleServiceSubmit = (e) => {
    ...
    // Validate price
    if (isNaN(Number(serviceForm.price)) || Number(serviceForm.price) <= 0) {
      toast({
        title: "Ошибка",
                          ...
                          <div className="p-4 flex flex-col justify-between flex-grow">
                            ...
                            <div className="flex justify-end gap-2 mt-3">
                              ...
                              <Button 
                                ...
                                onClick={() => handleDeleteItem(doctor.id, "doctor")}
                              >
