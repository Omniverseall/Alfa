...
import { MapPin, Phone, Clock, Stethoscope, HeartPulse, FlaskConical, ChevronRight, ArrowRight } from "lucide-react";
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {doctors.slice(0, 4).map((doctor) => (
              <div key={doctor.id} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.slice(0, 6).map((service) => (
              <div key={service.id} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {news.slice(0, 3).map((item) => (
              <div key={item.id} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg">
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="text-gray-700 space-y-3">
              <div className="flex items-start"><MapPin className="h-5 w-5 mr-2 text-brand-red" /> г. Ташкент, Карасу-4, дом 2</div>
              <div className="flex items-start"><Phone className="h-5 w-5 mr-2 text-brand-red" /> <a href="tel:+998712345678" className="hover:text-brand-blue">+998 71 234-56-78</a></div>
              <div className="flex items-start"><Clock className="h-5 w-5 mr-2 text-brand-red" /> Пн-Сб: 8:00-20:00, Вс: 9:00-18:00</div>
            </div>
          </div>
          <div className="h-[450px] rounded-lg overflow-hidden shadow-md">
            <iframe
              src="https://yandex.ru/map-widget/v1/?ll=69.374905%2C41.331574&z=20&l=map"
              width="100%"
              height="100%"
              frameBorder="0"
              allowFullScreen
